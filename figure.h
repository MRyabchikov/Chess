...
{  // Graph_lib::Image
    ...
    virtual int correct_step (Cell& c1, Cell& c2, Chessboard& chess, bool ensure_king_is_safe = true /*false*/) = 0;
...
struct Pawn : Figure
{
    ...
    int correct_step (Cell& c1, Cell& c2, Chessboard& chess, bool ensure_king_is_safe = true /*false*/);
